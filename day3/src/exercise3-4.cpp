...
// シェーダファイル
static const std::string RENDER_VSHADER_FILE = std::string(SHADER_DIRECTORY) + "normal-map.vert";
static const std::string RENDER_FSHADER_FILE = std::string(SHADER_DIRECTORY) + "normal-map.frag";

// モデルのファイル
static const std::string BUNNY_FILE = std::string(DATA_DIRECTORY) + "teapot.obj";

//　テクスチャファイル
static const std::string DIFFUSE_TEX_FILE = std::string(DATA_DIRECTORY) + "sweater_diff.png";
static const std::string BUMP_TEX_FILE = std::string(DATA_DIRECTORY) + "sweater_normal.png";
...
void paintGL() {
    ...
    glm::mat4 viewMat = glm::lookAt(glm::vec3(5.0f, 5.0f, 5.0f),   // 視点の位置
